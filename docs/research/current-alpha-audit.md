...
baseline, not the current `0.3.0a1` tree. See the
[SDK standards contract](../sdk-standards.md) for the implemented native
compiler/routing, QIR, runtime, pulse-adapter, and loss-report boundaries.
